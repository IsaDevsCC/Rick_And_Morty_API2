...
/**
 * EL TEST, NO COMPRENDO MUY BIEN EL PORQUÉ FALLA, YA QUE CONSIDERO HE IMPLEMENTADO LOS PASOS REQUERIDOS PARA QUE SEA EXITOSO,
 * RETORNA UN ERROR MUY EXTRAÑO, COMO SI EL DISPATCHER NO SE EJECUTARA EN EL HULI CORRECTO, INTENTÉ MANIPULAR EL DISPATCHER CON UN ENLACE PROPIO DE ANDROID PERO SIGUE SIN RESPONDER, CONSIDERO,
 * DEBE DE DEBERSE A ESA CAUSA
 */
